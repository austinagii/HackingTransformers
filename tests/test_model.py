...
from prism.model import Embedding
...
class TestEmbedding:
    ...
    @pytest.mark.parametrize(
        ("num_embeddings", "embedding_dim", "input_shape"),
        [
            (32, 16, (1, 2)),
            (64, 8,  (3, 4)),
        ]
    )
    def test_error_is_raised_for_invalid_embedding_shape(
        self,
        num_embeddings: int,
        embedding_dim: int,
        ...
        with pytest.raises(IndexError):
            embedding(torch.randint(0, num_embeddings, input_shape))
